...
def observations_schema(resource, schema_json_file):
    ...
    resource.schema.get_field("id_confidence").constraints["enum"] = ["Confirmed"]
...
def main():
    ...
    validate_data_file("schema_vegetation_plots.json")
