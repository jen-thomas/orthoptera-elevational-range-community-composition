...
create_finalised_observations <- function(finalised_observations) {
  #' Create a new record for each specimen with finalised observation. Each specimen needs to have one
  #' record which can be used in the function to get the number of species at each site. Therefore, the
  #' finalised identifications, and those that are already identified as confirmed observations for each
  #' site, will be manually checked and a decision made about how the specimen should be recorded so that
  #' it adds (or not) to the species richness for a particular site, as required.
  #'
  ...
  BES0120210914H1C007 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "BES01 20210914 H1 C007", ]
  ...
  #' #' Neither of these genus are currently listed at the site.
  BES0220210720H1C002 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "BES02 20210720 H1 C002", ]
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  BES0220210720H1C002_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     BES0220210720H1C002_notconservative)

  #' ### MOL08 20210915 H1 C002
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  MOL0820210915H1C002 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "MOL08 20210915 H1 C002", ]
  ...
  MOL0820210915H1C002_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  MOL0820210915H1C002_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     MOL0820210915H1C002_notconservative)

  #' ### MOL08 20210915 N1 C002
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  MOL0820210915N1C002 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "MOL08 20210915 N1 C002", ]
  MOL0820210915N1C002_conservative <- MOL0820210915N1C002[1, ]
  MOL0820210915N1C002_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  MOL0820210915N1C002_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     MOL0820210915N1C002_notconservative)

  #' ### MOL09 20210915 H1 C014
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  MOL0920210915H1C014 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "MOL09 20210915 H1 C014", ]
  ...
  MOL0920210915H1C014_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  MOL0920210915H1C014_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     MOL0920210915H1C014_notconservative)

  #' ### MOL09 20210915 N1 C005
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  MOL0920210915N1C005 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "MOL09 20210915 N1 C005", ]
  MOL0920210915N1C005_conservative <- MOL0920210915N1C005[1, ]
  MOL0920210915N1C005_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  MOL0920210915N1C005_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     MOL0920210915N1C005_notconservative)

  #' MOL09 20211002 H1 C001
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  MOL0920211002H1C001 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "MOL09 20211002 H1 C001", ]
  MOL0920211002H1C001_conservative <- MOL0920211002H1C001[1, ]
  MOL0920211002H1C001_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  MOL0920211002H1C001_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     MOL0920211002H1C001_notconservative)

  #' ### MOL09 20210915 N1 C002
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  MOL0920210915N1C002 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "MOL09 20210915 N1 C002", ]
  MOL0920210915N1C002_conservative <- MOL0920210915N1C002[1, ]
  MOL0920210915N1C002_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  MOL0920210915N1C002_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     MOL0920210915N1C002_notconservative)

  #' ### MOL09 20211002 H1 C002
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  MOL0920211002H1C002 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "MOL09 20211002 H1 C002", ]
  MOL0920211002H1C002_conservative <- MOL0920211002H1C002[1, ]
  MOL0920211002H1C002_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  MOL0920211002H1C002_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     MOL0920211002H1C002_notconservative)

  #' ### TAV07 20210618 N1 C029
  #' One of the genus (Gomphocerus) has been seen at the site.
  TAV0720210618N1C029 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TAV07 20210618 N1 C029", ]
  ...
  TAV0720210618N1C029_conservative["genus"] <- "Gomphocerus" # don't add another taxa, because it could
  # be one that has already been seen there
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TAV0720210618N1C029_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TAV0720210618N1C029_notconservative)

  #' ### TAV08 20210916 H1 C010
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TAV0820210916H1C010 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TAV08 20210916 H1 C010", ]
  ...
  TAV0820210916H1C010_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  TAV0820210916H1C010_notconservative <- TAV0820210916H1C010[1, ]
  TAV0820210916H1C010_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TAV0820210916H1C010_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TAV0820210916H1C010_notconservative)

  #' ### TAV08 20210916 H1 C006
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TAV0820210916H1C006 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TAV08 20210916 H1 C006", ]
  TAV0820210916H1C006_conservative <- TAV0820210916H1C006[1, ]
  TAV0820210916H1C006_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  TAV0820210916H1C006_notconservative <- TAV0820210916H1C006[1, ]
  TAV0820210916H1C006_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TAV0820210916H1C006_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TAV0820210916H1C006_notconservative)

  #' ### TAV08 20210916 H1 C008
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TAV0820210916H1C008 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TAV08 20210916 H1 C008", ]
  TAV0820210916H1C008_conservative <- TAV0820210916H1C008[1, ]
  TAV0820210916H1C008_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that
  # has already been seen there
  TAV0820210916H1C008_notconservative <- TAV0820210916H1C008[1, ]
  TAV0820210916H1C008_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TAV0820210916H1C008_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TAV0820210916H1C008_notconservative)

  #' ### TAV08 20211006 H1 C007
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TAV0820211006H1C007 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TAV08 20211006 H1 C007", ]
  TAV0820211006H1C007_conservative <- TAV0820211006H1C007[1, ]
  TAV0820211006H1C007_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that has already been seen there
  TAV0820211006H1C007_notconservative <- TAV0820211006H1C007[1, ]
  TAV0820211006H1C007_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TAV0820211006H1C007_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TAV0820211006H1C007_notconservative)

  #' ### TAV08 20210916 H1 C012
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TAV0820210916H1C012 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TAV08 20210916 H1 C012", ]
  TAV0820210916H1C012_conservative <- TAV0820210916H1C012[1, ]
  TAV0820210916H1C012_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that has already been seen there
  TAV0820210916H1C012_notconservative <- TAV0820210916H1C012[1, ]
  TAV0820210916H1C012_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TAV0820210916H1C012_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TAV0820210916H1C012_notconservative)

  #' ### TAV09 20211006 N1 C008
  #' Neither of these species have been seen at this site before.
  TAV0920211006N1C008 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TAV09 20211006 N1 C008", ]
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TAV0920211006N1C008_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TAV0920211006N1C008_notconservative)
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TOR0120210629N1E007_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TOR0120210629N1E007_notconservative)

  #' ### TOR02 20210629 N1 E001
  #' Both of these genus have already been seen at this site so it won't add any new taxa
  TOR0220210629N1E001 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TOR02 20210629 N1 E001", ]
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TOR0220210629N1E001_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TOR0220210629N1E001_notconservative)

  #' ### TOR02 20210919 N1 C005
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TOR0220210919N1C005 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TOR02 20210919 N1 C005", ]
  TOR0220210919N1C005_conservative <- TOR0220210919N1C005[1, ]
  TOR0220210919N1C005_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that has already been seen there
  TOR0220210919N1C005_notconservative <- TOR0220210919N1C005[1, ]
  TOR0220210919N1C005_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TOR0220210919N1C005_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TOR0220210919N1C005_notconservative)

  #' ### TOR02 20210919 N1 C001
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TOR0220210919N1C001 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TOR02 20210919 N1 C001", ]
  TOR0220210919N1C001_conservative <- TOR0220210919N1C001[1, ]
  TOR0220210919N1C001_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that has already been seen there
  TOR0220210919N1C001_notconservative <- TOR0220210919N1C001[1, ]
  TOR0220210919N1C001_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TOR0220210919N1C001_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TOR0220210919N1C001_notconservative)

  #' ### TOR02 20211004 H1 C001
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TOR0220211004H1C001 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TOR02 20211004 H1 C001", ]
  TOR0220211004H1C001_conservative <- TOR0220211004H1C001[1, ]
  TOR0220211004H1C001_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that has already been seen there
  TOR0220211004H1C001_notconservative <- TOR0220211004H1C001[1, ]
  TOR0220211004H1C001_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TOR0220211004H1C001_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TOR0220211004H1C001_notconservative)

  #' ### TOR05 20210919 H1 C008
  #' Both species have already been seen at this site so it will not add any taxa
  TOR0520210919H1C008 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TOR05 20210919 H1 C008", ]
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TOR0520210919H1C008_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TOR0520210919H1C008_notconservative)

  #' ### TOR09 20210616 N1 C004
  #' Chorthippus  have already been seen at this site
  TOR0920210616N1C004 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TOR09 20210616 N1 C004", ]
  ...
  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TOR0920210616N1C004_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TOR0920210616N1C004_notconservative)

  #' ### TOR10 20211004 H1 C002
  #' Chorthippus biguttulus (one of the options) has already been seen at this site.
  TOR1020211004H1C002 <- finalised_observations[finalised_observations$specimen_label ==
                                                  "TOR10 20211004 H1 C002", ]
  ...
  TOR1020211004H1C002_conservative["species"] <- "Chorthippus biguttulus" # don't add another taxa,
  # because it could be one that has already been seen there
  TOR1020211004H1C002_notconservative <- TOR1020211004H1C002[1, ]
  TOR1020211004H1C002_notconservative["species"] <- "Chorthippus mollis" # could be a different genus
  # though, so add a taxa

  finalised_identifications_conservative <- rbind(finalised_identifications_conservative,
                                                  TOR1020211004H1C002_conservative)
  finalised_identifications_notconservative <- rbind(finalised_identifications_notconservative,
                                                     TOR1020211004H1C002_notconservative)

  finalised_identifications <- list(finalised_identifications_conservative,
